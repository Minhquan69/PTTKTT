...
public class CountingInversions {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println();
        System.setIn(new FileInputStream(new File("tenSV.txt")));
        ...
        StdOut.println(Inversions.count(a)); // dem so luong dao nguoc trong mang a
        StdOut.println(Inversions.count(b)); // dem so luong dao nguoc trong mang b
    }
}
