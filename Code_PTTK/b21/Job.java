...
{ 
    ...
    private List<item_job> jobs;
    private Bag<item_job> bag;
    
    public Job(List<item_job> jobs){
        bag = new Bag<item_job>();
        this.jobs = jobs;
    ...
    private int findLastNonConflictingJob(List<item_job> jobs, int n)
    {
        // search space
        int low = 0;
        int high = n;
    ...
    public Bag<item_job> bag(){
        return bag;
    }
    public static void main(String[] args)
    {
        List<item_job> jobs = Arrays.asList(     new item_job( 0, 6, 40, "Job 1:"),
                                            new item_job( 1, 4, 30, "Job 2:"),
                                            new item_job( 3, 5, 30, "Job 3:"),
                                            new item_job( 5, 7, 20, "Job 4:"),
                                            new item_job( 5, 9, 10, "Job 5:"),
                                            new item_job( 7, 8, 10, "Job 6:")
                                            );
